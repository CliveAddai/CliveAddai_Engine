...
bool GameScene::OnCreate() {
	...
	model1 = new Model(ShaderHandler::GetInstance()->GetShader("colourShader"));
	model1->AddMesh(new Mesh(vertexList, ShaderHandler::GetInstance()->GetShader("colourShader")));
...
void GameScene::Update(const float deltaTime_) {
	model1->SetAngle(model1->GetAngle() + 0.005f);
}
